...
const showInfo = (object, property) => {
...
const foreignBooks = [
  ...
  {
    'book title': 'Книга Исцеления',
    'author': 'Ибн Сина',
    'year of publication': 1120,
    'cover color': 'белый',
    'genre':'научный'
  } 
];
...
const checkBooksIsOld = (booksWorld) => {
  return booksWorld.map(booksWorld => ({...booksWorld, isRare: booksWorld['year of publication'] < 2000}))   
  }
